...
happyExpList = Happy_Data_Array.listArray (0,59) ([35584,22531,15388,0,1814,14512,0,1,0,0,32768,7,58048,5632,45063,32824,453,64,158,0,0,49152,226,0,0,96,768,7680,4,33675,519,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","EAB","'+'","'*'","'or'","'and'","'not'","'('","')'","'let'","'='","'in'","'end'","num","bool","var","%eof"]
...
action_2 (5) = happyShift action_10
action_2 (6) = happyShift action_11
action_2 (7) = happyShift action_12
action_2 (8) = happyShift action_13
...
action_9 (6) = happyShift action_11
...
action_15 (5) = happyShift action_10
...
action_21 (7) = happyShift action_12
action_21 (8) = happyShift action_13
action_21 _ = happyReduce_2

action_22 (7) = happyShift action_12
action_22 (8) = happyShift action_13
action_22 _ = happyReduce_1

action_23 (5) = happyShift action_10
action_23 (6) = happyShift action_11
action_23 (7) = happyShift action_12
action_23 (8) = happyShift action_13
...
action_25 (5) = happyShift action_10
