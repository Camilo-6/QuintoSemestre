...
estep_n :: State -> Int -> State
estep_n e n = if n == 0
            then e
            else estep_n (E.step e) (n-1)
...
pgm7 = test_parser "MiniHs/mypgm/algo.minihs"
pgm8 = test_parser "MiniHs/mypgm/algo2.minihs"
pgm9 = test_parser "MiniHs/mypgm/algo3.minihs"
